...
const products = [
  ...
  },
  {
    ...
    productType: 'Body Care',
    vendor: 'Hubs & Babydoll',
    bodyHtml: 'Elevate your daily care with a sophisticated, pure floral shield. This blend locks in vital moisture all day long, draping your skin in an intoxicating, delicate floral bouquet that protects against environmental dryness.',
    variants: {
      price: '68.00',
    },
  },
